...
namespace Dopple.BackTracers
{
    public class ConstructorReturnBackTracer : SingeIndexBackTracer
    {
        ...
        protected override IEnumerable<InstructionNode> GetDataflowBackRelatedArgGroup(InstructionNode instructionNode)
        {
            ...
            var constructorCalls = SingleIndexBackSearcher.SearchBackwardsForDataflowInstrcutions(x => x is ConstructorCallNode && ((ConstructorCallNode) x).TargetMethodDefinition == instructionNode.Method, instructionNode);
